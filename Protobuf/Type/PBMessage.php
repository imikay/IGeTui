...
abstract class PBMessage
{
    ...
    public function __construct($reader=null)
    {
        $this->reader = $reader;
        $this->value = $this;
        $this->base128 = new PBBase128Varint(PBMessage::MODUS);
    }
    ...
    protected function _set_value($index, $value)
    {
        ...
        {            
            ...
            // if ($class == 'PBBool' || $class == 'PBBytes' || $class == 'PBEnum' || $class == 'PBScalar' || $class == 'PBSignedInt' || $class == 'PBString' || $class == 'PBInt')
            // {
            //     $namespace = 'Protobuf\\Type\\';
            // }                
            // else
